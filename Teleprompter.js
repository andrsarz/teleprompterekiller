      ...
      if (setting == 'lang') {
        ...
        if (setting == 'bg' || setting == 'fg') {
          ...
          editElement += `
            ...
            <input type="text" id="editor_${setting}" value="${this[setting].join(', ')}" />
          `;
        } else {
      ...
      if ((setting == 'bg' || setting == 'fg') && document.getElementById(`editor_${setting}_color`)) {
        ...
        colorInput.addEventListener('input', () => {
          ...
          if (hex && hex.length === 7) {
            ...
            this.editChange(setting); // riusa tutta la logica esistente (localStorage, warning, ecc.)
          }
        });
      }
